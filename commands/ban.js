...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        message.channel.send(embed.setDescription(`${member} adlı kullanıcı ${message.author} tarafından **${reason}** sebebiyle sunucudan yasaklandı!`)).then(x => x.delete({ timeout: 5000 }))
